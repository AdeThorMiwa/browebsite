...
export default function StickyBar() {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 p-4" style={{ backgroundColor: 'rgba(14,14,15,0.95)', backdropFilter: 'blur(12px)', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <a
        href={WA_LINK}
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-3 w-full py-4 rounded-2xl text-base font-bold text-black transition-opacity active:opacity-80"

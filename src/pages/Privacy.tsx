...
const sections = [
    ...
    content: (
      <>
        ...
        <p className="mt-3">
          ...
          <a
            href="mailto:privacy@usebro.xyz"
            className="text-accent hover:underline"
          >
            privacy@usebro.xyz
          </a>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          When you interact with Bro via WhatsApp, we may collect and store the
          following:
        </p>
        <ul className="mt-4 space-y-2">
          {[
            [
              "Your phone number",
              "used as your unique identifier on our platform",
            ],
            ...
            [
              "Interaction history",
              "a record of past orders and requests to provide better service",
            ],
          ].map(([term, def]) => (
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          We use the information we collect solely to operate the Bro service:
        </p>
        <ul className="mt-4 space-y-2">
          {[
  ...
  },
  {
    ...
    content: (
      <p>
        Bro communicates with you through WhatsApp, which is operated by Meta
        Platforms, Inc. When you message Bro on WhatsApp, your messages are
        transmitted through Meta's infrastructure. Meta's own privacy policy
        governs how they handle your data within their platform. You can review
        Meta's privacy policy at{" "}
        <a
        ...
        . Bro uses the WhatsApp Business API, which means your messages are
        delivered to our secure internal systems for processing. We access only
        what you send to us directly.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Your data is stored securely in a private database accessible only to
        authorised Bro staff. We use industry-standard security practices to
        protect your information from unauthorised access, disclosure, or loss.
        We retain your data for as long as you are an active Bro user, plus a
        reasonable period thereafter for record-keeping purposes. You may
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-3">
          We may share limited information with the following parties only as
          necessary to fulfil your orders:
        </p>
        <ul className="mt-4 space-y-2">
          {[
            [
      ...
      <>
        ...
        <ul className="mt-4 space-y-2">
          {[
            ...
            [
              "Opt out",
              "stop using the service at any time by simply not messaging us",
            ],
          ].map(([term, def]) => (
            <li key={term} className="flex gap-2">
              <span className="text-accent mt-1 flex-shrink-0">—</span>
        ...
        <p className="mt-4">
          To exercise any of these rights, message us on WhatsApp or send an
          email to{" "}
          <a
            href="mailto:privacy@usebro.xyz"
            className="text-accent hover:underline"
  ...
  },
  {
    ...
    content: (
      <p>
        Bro is not intended for use by anyone under the age of 13. We do not
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        are significant, we will notify active users via WhatsApp. Continued use
        of Bro after changes are posted constitutes acceptance of the updated
        policy.
      </p>
    ),
  },
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#0e0e0f" }}>
      ...
      >
        <div className="max-w-2xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white/30">
          <Link
            to="/"
            className="font-mono font-bold text-white tracking-tighter"
          >
            bro.
          </Link>
          <span>© 2026 Bro</span>

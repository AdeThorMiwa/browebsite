...
const WA_RIDER_LINK =
  "https://wa.me/2349120134931?text=I%20want%20to%20ride%20with%20Bro";
    ...
    <section className="relative flex flex-col items-center justify-center min-h-screen px-6 text-center pt-20">
      ...
      <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
        ...
        <p className="text-lg md:text-xl text-white/50 max-w-xl leading-relaxed mb-10">
          Deliver for Bro and get paid for every order you complete. Flexible
          hours, local routes, daily payouts.
        </p>
        ...
        <p className="mt-6 text-sm text-white/30">
          No office visit. No paperwork. Just WhatsApp.
        </p>
      </div>
...
const requirements = [
  {
    emoji: "🏍️",
    label: "A bike or car",
    sub: "Okada, tricycle, or car — all welcome.",
  },
  {
    emoji: "📱",
    label: "A smartphone",
    sub: "You need WhatsApp to receive and manage orders.",
  },
  {
    emoji: "🪪",
    label: "A valid ID",
    sub: "Government-issued ID — driver's licence, NIN, or passport.",
  },
  {
    emoji: "📍",
    label: "Based locally",
    sub: "You should be operating in a city where Bro is active.",
  },
];
    ...
    >
      ...
      >
        <div className="px-8 pt-12 pb-6 md:px-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mt-3 tracking-tight">
            If you have a bike and a phone,
            <br className="hidden md:block" /> you're almost there.
          </h2>
        </div>
          ...
          >
            <div className="flex items-start justify-between">
              <div
                ...
                style={{
                  backgroundColor: "rgba(0,229,122,0.1)",
                  color: "#00e57a",
                }}
              >
                {i + 1}
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{
                  backgroundColor:
                    open === i ? "#00e57a" : "rgba(255,255,255,0.08)",
    ...
    >
      <div
        ...
        style={{
          backgroundColor: "#00e57a",
          backgroundImage:
            "radial-gradient(ellipse 60% 80% at 50% 120%, rgba(0,0,0,0.15) 0%, transparent 70%)",
        }}
      >
        ...
        <p className="text-black/60 max-w-md text-base leading-relaxed">
          Message Bro on WhatsApp and we'll get you set up. Takes less than 5
          minutes to apply.
        </p>
        <a
          href={WA_RIDER_LINK}
